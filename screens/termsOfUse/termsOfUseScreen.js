    ...
    return (
      <SafeAreaView style={{ flex: 1, backgroundColor: "#F2F4F6" }}>
        ...
        <ScrollView style={{ flex: 1 }}>
          {this.header()}
          <Text style={styles.textHeader}>1. Introduction</Text>
          <Text style={styles.dummyTextStyle}>
            Welcome to Primecard Ltd (“Company”, “we”, “our”, “us”)! These Terms
            of Service (“Terms”, “Terms of Service”) govern your use of our
            website located at primecard.net (together or individually
            “Service”) operated by Primecard Ltd. Our Privacy Policy also
            ...
            web pages. Your agreement with us includes these Terms and our
            ...
            info@primecard.net so we can try to find a solution. These Terms
            apply to all visitors, users and others who wish to access or use
            Service.
          </Text>
          <Text style={styles.textHeader}>2. Communications</Text>
          <Text style={styles.dummyTextStyle}>
            ...
            emailing at info@primecard.net.
          </Text>
          ...
          <Text style={styles.textHeader}>4. Content</Text>
          <Text style={styles.dummyTextStyle}>
            ...
            these Terms. Primecard Ltd has the right but not the obligation to
            monitor and edit all Content provided by users. In addition, Content
            found on or through this Service are the property of Primecard Ltd
          ...
          <Text style={styles.textHeader}>5. Prohibited Uses</Text>
          <Text style={styles.dummyTextStyle}>
            ...
            any applicable national or international law or regulation. 0.2. For
            ...
            “chain letter,” “spam,” or any other similar solicitation. 0.4. To
            ...
            unlawful, illegal, fraudulent, or harmful purpose or activity. 0.6.
            ...
            engage in real time activities through Service. 0.2. Use any robot,
            ...
            material on Service. 0.3. Use any manual process to monitor or copy
            ...
            material which is malicious or technologically harmful. 0.6. Attempt
            ...
            server, computer, or database connected to Service. 0.7. Attack
            Service via a denial-of-service attack or a distributed
            denial-of-service attack. 0.8. Take any action that may damage or
            falsify Company rating. 0.9. Otherwise attempt to interfere with the
            proper working of Service.
          </Text>
          <Text style={styles.textHeader}>6. Analytics</Text>
          <Text style={styles.dummyTextStyle}>
            We may use third-party Service Providers to monitor and analyze the
            use of our Service.
          </Text>
          <Text style={styles.textHeader}>7. No Use By Minors</Text>
          <Text style={styles.dummyTextStyle}>
          ...
          <Text style={styles.textHeader}>8. Intellectual Property</Text>
          <Text style={styles.dummyTextStyle}>
            Service and its original content (excluding Content provided by
            users), features and functionality are and will remain the exclusive
            property of Primecard Ltd and its licensors. Service is protected by
            ...
            without the prior written consent of Primecard Ltd.
          </Text>
          <Text style={styles.textHeader}>9. Copyright Policy</Text>
          <Text style={styles.dummyTextStyle}>
            ...
            info@primecard.net, with the subject line: “Copyright Infringement”
          ...
          <Text style={styles.dummyTextStyle}>
            ...
            interest; 0.2. a description of the copyrighted work that you claim
            ...
            copyrighted work; 0.3. identification of the URL or other specific
            location on Service where the material that you claim is infringing
            is located; 0.4. your address, telephone number, and email address;
            0.5. a statement by you that you have a good faith belief that the
            disputed use is not authorized by the copyright owner, its agent, or
            the law; 0.6. a statement by you, made under penalty of perjury,
          ...
          <Text style={styles.dummyTextStyle}>
            You may provide us either directly at info@primecard.net or via
          ...
          <Text style={styles.textHeader}>12. Links To Other Web Sites</Text>
          <Text style={styles.dummyTextStyle}>
            Our Service may contain links to third party web sites or services
            that are not owned or controlled by Primecard Ltd. Primecard Ltd has
            ...
            THAT COMPANY SHALL NOT BE RESPONSIBLE OR LIABLE, DIRECTLY OR
          ...
          <Text style={styles.textHeader}>13. Disclaimer Of Warranty</Text>
          <Text style={styles.dummyTextStyle}>
          ...
          <Text style={styles.textHeader}>14. Limitation Of Liability</Text>
          <Text style={styles.dummyTextStyle}>
          ...
          <Text style={styles.textHeader}>15. Termination</Text>
          <Text style={styles.dummyTextStyle}>
          ...
          <Text style={styles.textHeader}>16. Governing Law</Text>
          <Text style={styles.dummyTextStyle}>
            These Terms shall be governed and construed in accordance with the
            laws of Mauritius, which governing law applies to agreement without
          ...
          <Text style={styles.textHeader}>17. Changes To Service</Text>
          <Text style={styles.dummyTextStyle}>
          ...
          <Text style={styles.textHeader}>18. Amendments To Terms</Text>
          <Text style={styles.dummyTextStyle}>
          ...
          <Text style={styles.textHeader}>19. Waiver And Severability</Text>
          <Text style={styles.dummyTextStyle}>
          ...
          <Text style={styles.textHeader}>20. Acknowledgement</Text>
          <Text style={styles.dummyTextStyle}>
            BY USING SERVICE OR OTHER SERVICES PROVIDED BY US, YOU ACKNOWLEDGE
            THAT YOU HAVE READ THESE TERMS OF SERVICE AND AGREE TO BE BOUND BY
            THEM.
          </Text>
          <Text style={styles.textHeader}>21. Contact Us</Text>
          <Text style={styles.dummyTextStyle}>
            Please send your feedback, comments, requests for technical support
            by email: info@primecard.net.
          </Text>
        </ScrollView>
      </SafeAreaView>
    );
